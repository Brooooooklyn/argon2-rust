...
//! // (RFC 9106's name for the raw hash output): the OWASP-style figure this
//! // crate ships as its default, and a sound starting point for a password
//! // store. One hash of it measures about 8 ms in a release build on an
//! // M-series laptop, cheap enough that this runs as a real doctest. Raise
//! // `m_cost` until it fits your own timing budget.
